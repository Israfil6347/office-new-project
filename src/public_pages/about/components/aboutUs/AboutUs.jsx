      ...
      <div>
        ...
        <div className="">
          ...
          >
            ...
            Gazipur, Narayanganj & Munshiganj districts with over 43,000 members
            currently active in "Dhaka Credit". "Dhaka Credit" is currently
            providing various services through its 12 service centers and 20
            collection booths. As of June 2022, there is nearly 600 professional
            staff along with part-time students currently employed in "Dhaka
            Credit".
          </p>
          <p
            className="mb-4"
          >
            ...
            ""Divine Mercy Hospital" at Kuchilabari in the district of Gazipur
            is under process and are looking to commence its operation in 2022.
            It is a 300-bed hospital situated in Gazipur, adjacent to dhaka
            city. The vast infrastructure having most of the health service
            departments will be completed by 2022 and will start its operation
            by the end of the year. This mega project will follow a medical
            college and a nursing college on the hospital’s vast campus.
          </p>
        </div>
      </div>
    </div>
